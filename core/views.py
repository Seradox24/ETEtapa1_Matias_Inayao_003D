...
from .forms import ProveedorForm,ProveedorForm1
...
def modificar_proveedor(request,id):
    ...
    data ={
        'form1': ProveedorForm1(instance=proveedor)
    }
    
    if request.method == 'POST':
        formulario = ProveedorForm1(data=request.POST,instance=proveedor,files=request.FILES)
        if formulario.is_valid():
            formulario.save()
